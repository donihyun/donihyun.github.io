            ...
            <div class="container navbar-container">
                ...
                <div class="navbar-menu">
                    ...
                    <div class="navbar-end">
                        <button type="button" class="navbar-item night" id="night-nav" title="Switch Color Scheme" aria-label="Switch Color Scheme" aria-pressed="false">
                            <i class="fas fa-moon" id="night-icon" aria-hidden="true"></i>
                        </button>
